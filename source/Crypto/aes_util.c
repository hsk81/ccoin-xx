...
#include <Crypto/ctaes.h> // for AES256_ctx, AES256_encrypt, etc
#include <Crypto/sha2.h> // for sha512_Update, sha512_Final, etc
#include <Miscellanea/util.h> // for bu_read_file, bu_write_file
